            ...
            <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    ...
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3 text-black ">
                            <h3 className="tracking-wide uppercase font-bold">Company Information</h3>
                            <ul className="space-y-1">
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="flex items-center gap-4"><FaPhoneSquare />0123456789</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="flex items-center gap-4"><FaLocationDot />873,South Margarete</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="flex items-center gap-4"><MdEmail /> abc@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3  text-black">
                ...
                <div className="py-6 text-sm text-center font-extrabold  text-black">© 1968 Company Co. All rights reserved.</div>
            </footer>
        </div>
    );
};
